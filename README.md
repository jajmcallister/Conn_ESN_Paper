...
### esn_weight_matrices
This folder contains the weight matrices for the Echo State Networks (ESNs) used in the paper. There are three subfolders: connectome-based, random (Erdos-Renyi), and configuration model (cfg) weight matrices. Within each of these subfolders, there are separate folders for larval and adult-based connectomes.
